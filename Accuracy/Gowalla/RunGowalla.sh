...
DESC_MOVELETS=$BASIC_PATH"./descriptors/Gowalla_Movelets.json"

DESC_MASTER=$BASIC_PATH"./descriptors/Gowalla_MASTER.json"
...
#java -Xmx55000M -jar "../JarFiles/MoveletsACMSAC.jar" -curpath "$BASIC_PATH" -respath "$BASIC_PATH" -descfile "$DESC_MOVELETS" -nt 2 -ms 2 -lp true -cache true | tee -a "$OUTPUT_Movelets"  
#wait
